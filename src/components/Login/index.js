...
const LogIn = () => {
  ...
  return (
    <Container className='nonito' component="main">
      ...
      <Typography  variant='h4'>vibes<sup className='rotated'>&reg;</sup></Typography>
      ...
      >
        ...
        <Grid item xs={8} sm={8} md={5} >
          ...
          >
            ...
            <Collapse in={open}>
              {validator.msg && (
                <Alert severity={showAlert ? "success": "error"} onClose={closeAlert}>
                  {validator.msg}
                </Alert>
              )}
            </Collapse>
              ...
              <Grid container>
                ...
                <Grid item xs={12}>
                  ...
                  <Grid container>
                    ...
                    <Grid item xs>
                      <NavLink to="/" variant="body2" style={{ textDecoration: 'none', color: 'red' }} >
                        Forgot password?
                      </NavLink>
                    </Grid>

                    <Grid item>
                      <NavLink to="/signup" variant="body2" style={{ textDecoration: 'none', color: 'red' }} >
